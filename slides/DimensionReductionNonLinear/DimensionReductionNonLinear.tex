...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Rtsne(scRNA\_expr, perplexity = 2): could not find function "{}Rtsne"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Rtsne(scRNA\_expr, perplexity = 10): could not find function "{}Rtsne"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Rtsne(scRNA\_expr, perplexity = 100): could not find function "{}Rtsne"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rbind(tSNE\_perp2, tSNE\_perp10, tSNE\_perp100): object 'tSNE\_perp2' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Rtsne(mollusk\_ab, perplexity = 2): could not find function "{}Rtsne"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Rtsne(log(1 + mollusk\_ab), perplexity = 10): could not find function "{}Rtsne"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Rtsne(log(1 + mollusk\_ab), perplexity = 50): could not find function "{}Rtsne"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rbind(tSNE\_perp2, tSNE\_perp10, tSNE\_perp50): object 'tSNE\_perp2' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library(umap): there is no package called 'umap'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in umap(scRNA\_expr): could not find function "{}umap"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'umap\_fit' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in umap(mollusk\_ab): could not find function "{}umap"{}}}\end{kframe}
\end{knitrout}
