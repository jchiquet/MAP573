...
\hlstd{mollusk} \hlkwb{<-}
  ...
  \hlkwd{select}\hlstd{(}\hlopt{-}\hlstd{Offset)} \hlopt{%>%}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Aesthetics must be either length 1 or the same as the data (158): x}}\end{kframe}
