...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Mclust(., modelNames = c("{}EII"{}, "{}EEI"{})): could not find function "{}Mclust"{}}}\begin{alltt}
\hlkwd{plot}\hlstd{(GMM,} \hlstr{'BIC'}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'GMM' not found}}\begin{alltt}
\hlstd{aricode}\hlopt{::}\hlkwd{ARI}\hlstd{(GMM}\hlopt{$}\hlstd{classification, classes)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sortPairs(c1, c2): object 'GMM' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'GMM' not found}}\end{kframe}
\end{knitrout}
