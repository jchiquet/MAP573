...
Only reatined project are known visible
...
Ce projet peut être sélectionné par 2 groupes d'étudiants.
...
**Groupe 1: Recherche exploratoire et descriptive**

**Groupe 2: Étude des différences géographiques**


_Mots-clés:_ réduction de dimension, visualisation, trajectoire


## Projets 5 : base [FEERIC]
...
_Mots-clés:_ Prédiction (classification), interprétabilité, modèle explicatifs
...
### Project 11: - Variational auto-encoders for generating time series 
