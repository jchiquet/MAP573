...
<div class="alert alert-danger">
  <strong>Information:</strong> From October 30 and for at least a month, all teachings are online via zoom (<a href="https://moodle.polytechnique.fr/enrol/index.php?id=9404">link in Moodle</a>). 
</div>

  - **Teachers** : Julien Chiquet (coordinator), Florian Bourgey, Élise Dumas
  - **Lectures/tutorials are 100% online** via zoom.
  - **Practicals and projects follow-up are 100% online** :'-(
