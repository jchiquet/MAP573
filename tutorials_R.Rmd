...
If you experience some difficulties for installing R and some dependencies, you can also use a remote R session to complete the tutorial by launching binder:  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/jchiquet/MAP573/master?urlpath=rstudio). You only need a web browser. The main drawbacks are that (i) you lose your progress each time you launch a new session and (ii) the binder image will take some time to launch (usually a few minutes).
