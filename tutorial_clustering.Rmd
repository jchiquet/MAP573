...
We stard with the sample of scRNA data presented during the course on non-linear dimension reduction approaches. 
...
3. Run the k-means for a varying number of clusters (say, between 1 and 20) with parameters `nstart` set to 20. Save the results.
...
We use the same SNP data studied during homework \#3. We analyze the 5500 most variant SNP for 728 individuals with various origin, with the following descriptors:
